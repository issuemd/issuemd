...
;(function(){
    ...
    var merge = require('./issuemd-merger.js');
    ...
    function toString (cols) {
        return formatter.string(this.toArray(), cols);
    }
    ...
    function md(input) {
        if(typeof input === "string"){
            ...
            return formatter.md(this.toArray());
        }
    }

    // return HTML render of all issues
    function html() {
        return formatter.html(this.toArray());
    }
    ...
    function remove(input){
        ...
        var indices = utils.typeof(input) === "array" ? input : Array.prototype.slice.call(arguments);
    ...
    function update(/* issue_update_object | modified, modifier[, (meta_array|meta_hash)][, body] */){
        var args;
    ...
    function comments(){
        ...
        if(this[0]){
            var out = [];
            utils.each(this[0].updates, function(update){
